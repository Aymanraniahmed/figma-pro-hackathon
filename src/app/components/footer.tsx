...
const Footer = () => {
  return (
    <div>
      <footer className="text-white w-full bg-[#2A254B] body-font">
          ...
          <div className="flex flex-wrap md:text-left text-center order-first">
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                <li>
                  <a className="text-white hover:text-[#F9A826]">First Link</a>
                </li>
                <li>
                  <a className="text-white hover:text-[#F9A826]">Second Link</a>
                </li>
                <li>
                  <a className="text-white hover:text-[#F9A826]">Third Link</a>
                </li>
                <li>
                  <a className="text-white hover:text-[#F9A826]">Fourth Link</a>
                </li>
              </nav>
            </div>
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
